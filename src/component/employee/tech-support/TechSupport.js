  ...
  <div className="container"> 
    <div className="row mb-2">
      ...
      <div className="col-md-8">
        <h2 className="text-primary float-end">Tech Support</h2>
      </div> 
    </div>
    <div className="row">
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-4">
                <div className="card border border-primary">
                  <div className="card-body">
                    ...
                    <h6 className="font-13 text-muted text-uppercase mb-2">Chat History</h6>
                    <div className="row">
                      <div className="col">
              ...
              <div className="col-xl-9 col-lg-8">
                <div className="card border border-primary">
                      ...
                      <div className="col-auto">
                        <div id="tooltips-container"> 
                          <a href="javascript: void(0);" className="text-reset font-19 py-1 px-2 d-inline-block">
                            <i className="fe-trash-2" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Chat" />
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="card-body">
                    <ul className="conversation-list" data-simplebar style={{maxHeight: 460}}>
                      <li className="clearfix">
                        ...
                        <div className="conversation-actions dropdown">
                          <button className="btn btn-sm btn-link" data-bs-toggle="dropdown" aria-expanded="false"><i className="mdi mdi-dots-vertical font-16" /></button>
                      ...
                      <li className="clearfix">
                        <div className="chat-avatar">
                          <img src="/assets/images/users/user-5.jpg" alt="James Z" className="rounded" />
                          <i>10:02</i>
                        </div>
                        <div className="conversation-text">
                          <div className="ctext-wrap">
                      ...
                      <li className="clearfix odd">
                        <div className="chat-avatar">
                          <img src="/assets/images/users/user-1.jpg" alt="Geneva M" className="rounded" />
                          <i>10:03</i>
                        </div>
                        <div className="conversation-text">
                          <div className="ctext-wrap">
                            ...
                            <div className="p-2">
                              <div className="row align-items-center">
                                ...
                                <div className="col ps-0">
                                  <a href="javascript:void(0);" className="text-muted fw-bold">UBold-sketch.zip</a>
                            ...
                            <div className="row">
                              ...
                              <div className="col-sm-auto">
                                <div className="btn-group">
                                  <a href="#" className="btn btn-light"><i className="fe-paperclip" /></a>
                                  <button type="submit" className="btn btn-success chat-send w-100"><i className="fe-send" /></button>
                                </div>
                              </div> 
                            </div> 
                          </form>
