      ...
      <div className="container">
        <div className="row mb-3">
          ...
          <div className="col-md-8">
            <h2 className="text-primary float-end">Social Media Portal</h2>
          </div>
        </div>
        <div className="row row-row">
          <div className="col-md-1 mb-3" />
          <div className="col-md-2 mb-3">
            <Link to="/social-media/message-center">
          ...
          <div className="col-md-2 mb-3">
            <Link to="/social-media/social-media-client">
              <div className="card bg-primary border-white">
                <div className="card-body text-center">
                  <img
          ...
          <div className="col-md-2 mb-3">
            <Link to="/social-media/social-media-artworks">
              <div className="card bg-primary border-white">
                <div className="card-body text-center">
                  <img
                    src="/assets/images/sub-dept/artworks.png"
                    width="70px"
                    className="mb-0"
                  />
                  <h5 className="text-white">Artworks</h5>
                </div>
              </div>
            </Link>
          </div>
          <div className="col-md-2 mb-3">
            <Link to="/social-media/social-media-reports">
              <div className="card bg-primary border-white">
                <div className="card-body text-center">
                  <img
