      ...
      <div className="navbar-custom">
        <div className="container-fluid">
          <ul className="list-unstyled topnav-menu float-end mb-0">
            <li className="dropdown notification-list topbar-dropdown">
              <Link
                ...
                to="/client-account-manager-admin/incoming-new-clients"
                role="button"
                aria-haspopup="false"
                aria-expanded="false"
              >
          ...
          <div className="logo-box">
            <a
              href="incoming-new-clients.html"
                          ...
                          >
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <a
                                    href="/client-account-manager-admin/incoming-new-clients/view-new-incoming-clients/client-business-details"
...
export default Viewnewincomingclients;
